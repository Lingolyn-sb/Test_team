...
public class Main {
   ...
   static String[] nsbBasicoOL = {"ADD", "EYE", "EAR", "BOAT", "HAPPY", "LION", "NIGHT", "MILK", "UNCLE", "THANK"};
    ...
    static String[] nsbExpertOL = {"EMBARRASS", "PUNCTURE", "SUSTAINABLE", "ACKNOWLEDGE", "WRIGGLE", "GREASE", "HARASS", "DECEIVE", "GUARANTEE", "RESILIENT"};

    static String[] nsbBasicoScrambled = {"DAD", "YEE", "RAE", "OATB", "PYHAP", "NILO", "HTGIN", "KLIM", "CELNU", "KNAHT"};
    static String[] nsbMedioScrambled = {"FEHC", "HSBUR", "RTSESI", "RTDESE", "NTEHKCI", "ADNYOM", "TSABFREAK", "OSEHR", "ETQUI", "TINESL"};
    static String[] nsbNormalScrambled = {"TNEGILLINET", "EDICRINBEL", "TAMCELASS", "TIONCELEBRA", "SORCSISS", "SIONTELEVI", "TERKILOME", "GRAMDIA", "UARYJAN", "CANMEXI"};
    static String[] nsbDificilScrambled = {"PEARSDISA", "LOGAPOIZE", "IATEAPPRCE", "MEDIATELYIM", "CKKNO", "CENSELI", "GHWEI", "MYRHE", "TIMEDIAUL", "STERYMIOU"};
    static String[] nsbExpertScrambled = {"RASSBEMAR", "TUREPUNC", "TAINABLESUS", "KNOWLEDGEACK", "GLEWRIG", "ASEGRE", "ASSHAR", "CEIVEDE", "RANTEEGUA", "SIIEENTRL"};

    /*DECLARACION DE NIVELES SPELLING BEE PARA COMPLETAR LETRAS (Pistas)*/
    static String[] nsbBasicoCL = {"AD_", "E_E", "EA_", "B_AT", "HA_PY", "LIO_", "NIG_T", "MIL_", "UN_LE", "THAN_"};
    static String[] nsbMedioCL = {"C_EF", "BRUS_", "SIST_R", "D_SERT", "KITCH_N", "MONDA_", "BREA_FAST", "HOR_E", "QU_TE", "LI_TEN"};
    static String[] nsbNormalCL = {"INTE_LIGENT", "INCR_DIBLE", "CLA_SMATE", "CELEB_ATION", "SCISS_RS", "TELE_ISION", "KILOME_ER", "DIAGRA_", "JANUA_Y", "MEXIC_N"};
    static String[] nsbDificilCL = {"DISAP_EAR", "APOL_GIZE", "APP_ECIATE", "IMMEDIA_ELY", "KNOC_", "LICEN_E", "W_IGH", "RHYM_", "MULTIMEDI_", "MYSTE_IOUS"};
    static String[] nsbExpertCL = {"EMBARRAS_", "PUNCT_RE", "SUSTAINABL_", "ACKNO_LEDGE", "WRIG_LE", "G_EASE", "HARAS_", "DECEIV_", "GUARA_TEE"};
    ...
    static String[][] sinyantVerbosRegulares = {
            {"participate",
    ...
    static String[][] sinyantVerbosIrregulares = {
            {"travel",
    ...
    static String[][] sinyantSustantivos = {
            {"profession",
    ...
    static String[][] sinyantPreposiciones = {
            {"over",
    ...
    static String[][] sinyantAdjetivos = {
            {"joyful",
    ...
    static String[][] sinyantExpresionesComunes = {
            {"how’s it going?",
    ...
    static String[][] coVerbosregulares = {
    ...
    static String[][] coVerbosIrregulares = {
    ...
    static String[][] coExpresionesComunes = {
            {"How are you?",
    ...
    static String[][] apVerboregulares = {
    ...
    static String[][] apVerboIrregulares = {
    ...
    static String[][] apExpresionescomunes = {
    ...
    public static void moduloGeneral() {
        do {
            ...
            System.out.println("\n\n\n              "+usuario+", ¿Quieres jugar de nuevo? Ingresa 0 para SI, ingresa cualquiero otro número para NO:");

            jugardenuevo = sc.nextInt();
        }
        while (jugardenuevo==0);
        if (jugardenuevo!=0){
            System.out.println("              Okay " + usuario + ". Fue un gusto que practicaras tu inglés con ayuda de Lingolyn, esperamos verte pronto. \nKeep going! You are awesome!! Have a good day ;)");
        }
    ...
    public static void modalidadTradicionalSpellingBee() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            String respuesta = sc.nextLine().trim();//quita los espacios raros y asi
    ...
    public static String[] obtenerPistasCompletar() {
        switch (nivelSpellingBee) {
            case 1:
                return nsbBasicoCL;
            case 2:
    ...
    public static void sbjCompletarLetrasFaltantes() {
        ...
        String[] palabrasIncompletas = obtenerPistasCompletar();

        aciertos = 0;
        errores = 0;
        int contadorFallosCompletar = 0;
        ...
        bienvenida();
        System.out.println("           En este juego deberás:\n           1. Observar la palabra a la que le falta UNA letra (se indica con un guión bajo: _ ).\n           2. Deberás escribir la palabra completa y correcta.\n           3. Las palabras que falles en la primera ronda serán repetidas al final.");
        contador();
        ...
        for (int i = 0; i < longitudRonda; i++) {
            ...
            String palabraIncompleta = palabrasIncompletas[i]; // Pista con el guion bajo

            System.out.println("\n--- Palabra #" + (i + 1) + " ---");
            System.out.println("          Completa la palabra: " + palabraIncompleta);

            System.out.print("Tu respuesta (completa): ");
            String intento = sc.nextLine().trim().toUpperCase();

            if (intento.equals(palabraCorrecta)) {
                System.out.println("✔ ¡Correcto! La palabra es: " + palabraCorrecta);
                aciertos++;
            } else {
                System.out.println("✘ Incorrecto. La palabra correcta era: " + palabraCorrecta);
                errores++;

                if (contadorFallosCompletar < indicesFallados.length) {
                    indicesFallados[contadorFallosCompletar] = i;
                    contadorFallosCompletar++;
                }
            }
        ...
        // SEGUNDA RONDA
        if (contadorFallosCompletar > 0) {
            System.out.println("\n==========================================================");
            System.out.println("          --- RONDA DE REPASO para " + contadorFallosCompletar + " palabra(s) fallada(s) ---");
            System.out.println("==========================================================\n");

            for (int f = 0; f < contadorFallosCompletar; f++) {
                ...
                String palabraIncompletaRepaso = palabrasIncompletas[indiceOriginal];

                System.out.println("\n--- Repaso Palabra #" + (f + 1) + " ---");
                System.out.println("          Completa la palabra: " + palabraIncompletaRepaso);
        ...
        // --- RESUMEN FINAL ---
        System.out.println("\n==========================================================");
        System.out.println("          Juego terminado: Completar Letras Faltantes (" + nnombre + ")");
    ...
    public static String[] obtenerPalabrasDesordenadas() {
        switch (nivelSpellingBee) {
            case 1:
                return nsbBasicoScrambled;
            case 2:
                return nsbMedioScrambled;
            case 3:
                return nsbNormalScrambled;
            case 4:
                return nsbDificilScrambled;
            case 5:
                return nsbExpertScrambled;
            default:
                return nsbBasicoScrambled;
        }
    }
